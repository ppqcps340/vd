...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/mumidp3404/www/blob/master/README.md?g#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/mumidp3404/www/blob/master/README.md?g#1"]');
